...
export default function TwitterPreview({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 mx-auto border-gray-200 dark:border-gray-800 p-4 rounded-xl border ">
      <div className="flex justify-between">
        <div className="flex items-center">
          <img className="h-11 w-11 rounded-full" src={imageURL} />
